...
const DataStory = () => {
  return (
    <section className="bg-brand-dark px-2 py-16 text-white md:px-0 md:py-24">
      <div className="mx-auto flex max-w-6xl flex-col gap-10 md:flex-row md:items-center md:gap-12">
        <div className="flex-1 overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-[0_30px_100px_-60px_rgba(0,0,0,0.7)] transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-[0_35px_120px_-60px_rgba(0,0,0,0.8)] cursor-pointer">
          <img
            ...
            className="w-full h-auto object-cover min-h-[320px] transition-transform duration-300 ease-in-out"
          />
        </div>

        <div className="flex-1 space-y-5 px-2 md:px-6">
